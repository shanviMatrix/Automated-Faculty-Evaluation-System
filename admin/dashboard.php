...
$total_feedback = mysqli_fetch_row(mysqli_query($conn, "SELECT COUNT(*) FROM feedback"))[0]; // was 'evaluation' — BUG FIXED
...
<div class="page-wrapper">
  <?php include("../includes/header.php"); ?>
    ...
    <div class="hero-banner">
      <h1>Welcome back, <?= htmlspecialchars(current_user_name()) ?> 🎉</h1>
    ...
    <div class="card">
      ...
      <div class="actions-grid">
        <a href="add_faculty.php"    class="action-card"><div class="action-card-icon">➕</div><div class="action-card-label">Add Faculty</div></a>
        <a href="manage_faculty.php" class="action-card"><div class="action-card-icon">👥</div><div class="action-card-label">Manage Faculty</div></a>
        <a href="view_feedback.php"  class="action-card"><div class="action-card-icon">📋</div><div class="action-card-label">View Feedback</div></a>
        <a href="../logout.php"      class="action-card pink"><div class="action-card-icon">🚪</div><div class="action-card-label">Logout</div></a>
      </div>
    </div>
